...
class VariationAPI {
  static Future<RxList<VariationData>> getVariations({
    ...
    final variationRes = VariationListResponse.fromJson(
        await handleResponse(await buildHttpResponse('${APIEndPoints.getVariation}?employee_id=$employeeId$statusFilter$pageQuery$perPageQuery', method: HttpMethodType.GET)));
