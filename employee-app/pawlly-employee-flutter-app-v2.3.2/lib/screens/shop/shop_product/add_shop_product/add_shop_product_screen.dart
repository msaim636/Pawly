                    ...
                    () => BottomSelectionSheet(
                      ...
                      listWidget: SelectCategoryComponent(
                        onSelectedList: (List<ShopCategory> val) {
                          ...
                          for (var element in addShopController.selectedCategory) {
                  ...
                  () => BottomSelectionSheet(
                    ...
                    listWidget: SelectTagsComponent(
                      onSelectedList: (List<UnitTagData> val) {
                        ...
                        for (var element in addShopController.selectedTag) {
        ...
        buildIconWidget(
          ...
          onTap: () {
            if (addShopController.isEdit.value) {
              for (var element in addShopController.addVariationsList[index].productVariationData) {
                element.isSelected(false);
              }
            } else {
              for (var element in addShopController.variationList[index].productVariationData) {
                element.isSelected(false);
              }
            }
          ...
          () => CheckboxListTile(
            ...
            onChanged: (bool? v) {
              ...
              if (!(addShopController.isHasVariation.value)) {
                for (var element in addShopController.addProductVariationDataList) {
                  element.isSelected(false);
                }
          ...
          children: [
            Container(
              decoration: boxDecorationDefault(
                ...
                color: ctx.cardColor,
                border: Border.all(color: Colors.black12.withValues(alpha: 0.12), width: 0.6),
              ),
              child: DropdownButtonFormField(
                ...
                initialValue: addShopController.selectedDiscountType.value,
              ).paddingLeft(16),
            ).expand(),
            16.width,
            Obx(
