...
class OrderAPIs {
  ...
  static Future<OrderDetailModel> getOrderDetail({required int orderId, required int orderItemId, String noteId = ""}) async {
    ...
    return OrderDetailModel.fromJson(
        await handleResponse(await buildHttpResponse('${APIEndPoints.getOrderDetails}?order_id=$orderId&order_item_id=$orderItemId$notificationId', method: HttpMethodType.GET)));
  }
