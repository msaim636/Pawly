...
class BookingApi {
  ...
  static Future<RxList<BookingDataModel>> getBookingFilterList({
    ...
    final bookingRes = BookingRes.fromJson(
        await handleResponse(await buildHttpResponse("${APIEndPoints.getBooking}?page=$page&per_page=$perPage$statusFilter$serviceFilter$searchBooking$nearbyBooking", method: HttpMethodType.GET)));
    if (page == 1) bookings.clear();
    bookings.addAll(bookingRes.data.validate());
