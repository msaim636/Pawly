...
class BookingsController extends GetxController {
  ...
  void getBookingList({bool showloader = true, String search = "", bool isNearByBooking = false}) {
  ...
  Future<void> acceptPublicBooking({required int bookingId, VoidCallback? onUpdateBooking}) async {
    isLoading(true);
    hideKeyBoardWithoutContext();
    try {
      Get.find<HomeController>().isLoading(true);
