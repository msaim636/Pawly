...
class DashboardData {
  ...
  int totalTrainingService;
  int totalFacility;
  int totalWalkerDuration;
  ...
  DashboardData({
    ...
    this.totalTrainingService = 0,
    this.totalFacility = 0,
    this.totalWalkerDuration = 0,
  });
  ...
  factory DashboardData.fromJson(Map<String, dynamic> json) {
    return DashboardData(
      ...
      totalTrainingService: json['total_trainingservice'] is int ? json['total_trainingservice'] : 0,
      totalFacility: json['total_facility'] is int ? json['total_facility'] : 0,
      totalWalkerDuration: json['total_walker_duration'] is int ? json['total_walker_duration'] : 0,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'total_trainingservice': totalTrainingService,
      'total_facility': totalFacility,
      'total_walker_duration': totalWalkerDuration,
    };
  }
}
