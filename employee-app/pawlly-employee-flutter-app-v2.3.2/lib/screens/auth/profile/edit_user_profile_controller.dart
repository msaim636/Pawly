...
class EditUserProfileController extends GetxController {
  ...
  Future<void> init() async {
    loginUserData.value.mobile = await getUserNumber().whenComplete(()=> isLoading(false));
  ...
  Future<void> updateUserProfile() async {
    ...
    AuthServiceApis.updateProfile(
      ...
      mobile: isProfilePhoto ? loginUserData.value.mobile : '+${mobileCont.text.trim().formatPhoneNumber(selectedCountry.value.phoneCode)}',
  ...
  Future<String> getUserNumber() async {
    isLoading(true);
    var res = await AuthServiceApis.viewProfile(id: loginUserData.value.id);
    return res.data.mobile.toString();
  }
}
