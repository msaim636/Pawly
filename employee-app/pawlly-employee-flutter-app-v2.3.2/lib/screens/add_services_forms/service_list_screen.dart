      ...
      () => AppScaffold(
        ...
        actions: [
          IconButton(
            ...
            icon: commonLeadingWid(imgPath: Assets.iconsIcFilterOutlined, color: isDarkMode.value ? Colors.white : switchColor, icon: Icons.filter_alt_outlined, size: 20),
          ),
          IconButton(
            onPressed: () async {
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text(serviceData.name.validate(),
                                            style: secondaryTextStyle(color: isDarkMode.value ? primaryColor : primaryTextColor, size: 14), maxLines: 1, overflow: TextOverflow.ellipsis),
                                        Text(
