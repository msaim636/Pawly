...
class AddServiceController extends GetxController {
  ...
  void getCategory() {
    isLoading(true);
    ServiceFormApis.getCategory(categoryType: serviceRole(loginUserData: loginUserData.value)).then((value) {
      isLoading(false);
  ...
  String serviceRole({required UserData loginUserData}) {
    if (loginUserData.userRole.contains(EmployeeKeyConst.veterinary)) {
      return ServicesKeyConst.veterinary;
    } else if (loginUserData.userRole.contains(EmployeeKeyConst.grooming)) {
      return ServicesKeyConst.grooming;
    } else if (loginUserData.userRole.contains(EmployeeKeyConst.training)) {
  ...
  Future<void> addServices() async {
    ...
    ServiceFormApis.addServices(
      ...
      type: serviceRole(loginUserData: loginUserData.value),
      ...
      if (isEdit.value) {
        toast(locale.value.serviceUpdatedSuccessfully);
      } else {
        toast(locale.value.serviceAddedSuccessfully);
      }
    });
  }
