            ...
            Stack(
              children: [
                ...
                Positioned(
                  ...
                  right: 10,
                  child: Container(
                    decoration: boxDecorationDefault(color: primaryColor.withValues(alpha: 0.6), shape: BoxShape.circle),
                    child: CloseButton(color: Colors.white.withValues(alpha: 0.9)),
                  ),
                ),
              ],
            ),
