                    ...
                    : isEmpty
                        ? Obx(
                            () => NoDataWidget(
                              ...
                              retryText: locale.value.reload,
                              imageWidget: const EmptyStateWidget().expand(),
                              onRetry: isLoading == true.obs ? null : onRetry,
                            ).paddingSymmetric(horizontal: 32).expand(),
                          )
                        : listWidget,
              ],
...
void serviceCommonBottomSheet(BuildContext context, {required Widget child, Color? backgroundColor}) {
