    ...
    return Semantics(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: enableBgColor
              ? isSelected
                  ? activeBackgroundColor ?? item.activeColor.withValues(alpha: 0.2)
                  : backgroundColor
              : backgroundColor,
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                IconTheme(
                  data: IconThemeData(
                    size: iconSize,
                    color: isSelected ? item.activeColor.withValues(alpha: 1) : item.inactiveColor ?? item.activeColor,
                  ),
                ...
                Container(
                  ...
                  padding: const EdgeInsets.symmetric(horizontal: 8),
                  child: Text(item.titleText, maxLines: 1, textAlign: item.textAlign, style: primaryTextStyle(color: isSelected ? item.activeColor.withValues(alpha: 1) : item.inactiveColor ?? item.activeColor, size: 14)),
                ),
                const Spacer(),
              ],
            ),
