...
Widget get commonDivider => Column(
      children: [
        Divider(indent: 3, height: 1, color: isDarkMode.value ? borderColor.withValues(alpha: 0.1) : borderColor.withValues(alpha: 0.5)).paddingSymmetric(horizontal: 16),
      ],
    );
...
Widget get bottomSheetDivider => Column(
      children: [
        ...
        Divider(
          indent: 3,
          height: 0,
          color: Get.isDarkMode ? borderColor.withValues(alpha: 0.2) : borderColor.withValues(alpha: 0.5),
        ),
        20.height,
      ],
    );
...
Future<DateTime?> showDurationTimePicker(BuildContext context, {DateTime? selectedDateTime}) async {
  final DateTime? dateTime = await showOmniDateTimePicker(
    context: context,
    initialDate: selectedDateTime ?? DateTime(0, 0, 0, 0, 0),
    ...
    theme: ThemeData(
        timePickerTheme: TimePickerThemeData(
          hourMinuteTextStyle: primaryTextStyle(),
        ),
