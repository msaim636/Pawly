class APIEndPoints {
  ...
  static const String deleteServiceFacility = 'delete-service-facility';
  static const String saveServiceFacility = "save-service-facility";
  static const String updateServiceFacility = "update-service-facility";

  // Duration
  static const String getDurationList = 'duration-list';
  static const String saveServiceDuration = 'save-service-duration';
  static const String updateServiceDuration = 'update-service-duration';
  static const String deleteServiceDuration = 'delete-service-duration';

  // One Day Service Price
  static const String getOneDayServicePrice = 'get-one-day-service-price';
  static const String saveOneDayServicePrice = 'one-day-service-price';

  // Training
  static const String getTrainingTypeList = 'training-list';
  static const String saveServiceTraining = "save-service-training";
  static const String updateServiceTraining = "update-service-training";
  static const String deleteServiceTraining = 'delete-service-training';
