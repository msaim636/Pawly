...
var lightPrimaryColor2 = primaryColor.withValues(alpha: 0.1);
...
Color shimmerPrimaryBaseColor = Colors.grey.withValues(alpha: 0.6);
Color shimmerDarkBaseColor = Colors.grey.withValues(alpha: 0.2);
Color shimmerLightBaseColor = Colors.grey.withValues(alpha: 0.1);