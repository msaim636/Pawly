...
class DottedLine extends StatelessWidget {
  ...
  Color _calculateGradientColor(
    ...
    return startColor
        .withAlpha((startColor.a + amountOfChangeInAlphaPerItem * index) as int)
        .withRed((startColor.r + amountOfChangeInRedPerItem * index) as int)
        .withGreen((startColor.g + amountOfChangeInGreenPerItem * index) as int)
        .withBlue((startColor.b + amountOfChangeInBluePerItem * index) as int);
  }
}