...
class OrderApis {
  ...
  static Future<List<CartListData>> getOrderList({
    ...
    final orderRes = OrderListModel.fromJson(await handleResponse(await buildHttpResponse("${APIEndPoints.getOrderList}?$searchValue&page=$page&per_page=$perPage$statusFilter", method: HttpMethodType.GET)));
  ...
  static Future<String> downloadInvoicePdf({
    required int orderId,
    String noteId = "",
  }) async {
    String notificationId = noteId.isNotEmpty ? '&notification_id=$noteId' : '';
    final response = await buildHttpResponse(
      "${APIEndPoints.downloadInvoice}?id=$orderId$notificationId",
