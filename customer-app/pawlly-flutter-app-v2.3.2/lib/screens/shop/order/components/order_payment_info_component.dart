        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              /// Delivery Charge
              detailWidgetPrice(title: '${locale.value.deliveryCharge} * ${locale.value.products}', value: orderData.logisticCharge * (orderData.orderDetails.otherOrderItems.length + 1), textColor: textPrimaryColorGlobal),
              ...
              Row(
                ...
                children: [
                  ...
                  PriceWidget(price: (orderData.orderDetails.productPrice + orderData.orderDetails.otherOrderItems.map((item) => item.productDetails.productAmount.validate()).fold(0, (sum, amount) => sum + amount)), size: 12),
                ],
              ).paddingBottom(10),
            ],
          ),
