              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Marquee(
                      child: Text(
                        '${selectAddressController.setSelectedAddressData.value.addressLine1}, ${selectAddressController.setSelectedAddressData.value.addressLine2}, ${selectAddressController.setSelectedAddressData.value.cityName} - ${selectAddressController.setSelectedAddressData.value.postalCode}, ${selectAddressController.setSelectedAddressData.value.stateName}, ${selectAddressController.setSelectedAddressData.value.countryName}',
