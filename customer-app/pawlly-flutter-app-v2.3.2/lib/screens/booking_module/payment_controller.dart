...
class PaymentController extends GetxController {
  ...
  void savePaymentApi({required int bid, required String txnId, required String paymentType, required int paymentStatus}) {
    isLoading(true);
  ...
  void handleBookNowClick(BuildContext context) {
    if (isFromBookingDetail) {
