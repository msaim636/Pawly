          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        8.height,
                        detailWidget(title: locale.value.schedule, value: scheduleDate).paddingSymmetric(horizontal: 8),
                        detailWidgetPrice(title: locale.value.price, value: appointment.payment.totalAmount, textColor: getPriceStatusColor(paymentStatus: appointment.payment.paymentStatus)).paddingSymmetric(horizontal: 8),
                        detailWidget(title: locale.value.duration, value: appointment.duration.toFormattedDuration(showFullTitleHoursMinutes: true)).paddingSymmetric(horizontal: 8),
                        detailWidget(
                        ...
                        ).visible(appointment.employeeName.isNotEmpty).paddingSymmetric(horizontal: 8),
                        detailWidget(title: locale.value.address, value: getAddressByServiceElement(appointment: appointment)).paddingSymmetric(horizontal: 8),
                      ],
                    ).expand(),
                  ],
                ),
                ...
                if (appointment.status.contains(BookingStatusConst.COMPLETED) && appointment.service.status.getBoolInt() && appointment.payment.paymentStatus.contains(PaymentStatus.PAID)) ...[
                  8.height,
                  AppButton(
                    width: Get.width,
  ...
  Widget detailWidgetPrice({required String title, required num value, Color? textColor}) {
    return Row(
      ...
      children: [
        ...
        2.width,
        Align(
          alignment: SELECTED_LANGUAGE_CODE == 'ar' ? Alignment.bottomRight : Alignment.bottomLeft,
          child: PriceWidget(
            price: value,
