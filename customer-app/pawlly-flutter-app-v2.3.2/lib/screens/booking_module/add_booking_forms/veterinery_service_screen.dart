                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        16.height,
                        AppTextField(
                          title: locale.value.additionalInfo,
                          textStyle: primaryTextStyle(size: 12),
                          controller: veterineryController.additionalInfoCont,
                          textFieldType: TextFieldType.MULTILINE,
                          minLines: 3,
                          decoration: inputDecoration(
                            context,
                            hintText: 'e.g. ${locale.value.additionalInfo}',
                            fillColor: context.cardColor,
                            filled: true,
                          ),
                        ).paddingSymmetric(horizontal: 16),
                        ...
                        AddFilesWidget(
                          ...
                          onFilePathRemove: (index) {
                            ...
                            toast(locale.value.medicalReportRemovedSuccessfully);
                          },
                        ),
                      ],
                    ),
                      ...
                      builder: (context, child) {
                        return Theme(
                          data: Theme.of(context).copyWith(
                            ...
                            textTheme: TextTheme(displayMedium: primaryTextStyle()),
                          ),
                          child: child!,
                        );
                      },
