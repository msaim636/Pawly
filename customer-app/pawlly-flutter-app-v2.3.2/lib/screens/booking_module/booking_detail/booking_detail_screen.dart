          ...
          child: Column(
            ...
            children: [
              ...
              detailWidget(
                ...
                value: bookingController.bookingDetail.value.payment.transactionType.capitalizeFirstLetter(),
              ),
          ...
          child: Column(
            ...
            children: [
              ...
              detailWidgetPrice(
                ...
                value: bookingController.bookingDetail.value.payment.taxs.map((e) => e.value).sumByDouble((p0) => p0),
                textColor: isDarkMode.value ? textPrimaryColorGlobal : secondaryColor,
                isSemiBoldText: true,
                isInfoIconShow: true,
                onTap: bookingController.showTaxInfo,
              ),
              detailWidgetPrice(
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              detailWidget(title: locale.value.additionalInformation, value: bookingController.bookingDetail.value.additionalInfo).visible(bookingController.bookingDetail.value.additionalInfo.isNotEmpty),
            ],
          ),
        ).paddingSymmetric(horizontal: 16),
      ],
      ...
      () => Column(
        ...
        children: [
          ...
          AppButton(
            ...
            textStyle: secondaryTextStyle(color: context.primaryColor, size: 14, fontFamily: GoogleFonts.beVietnamPro(fontWeight: FontWeight.w500).fontFamily),
