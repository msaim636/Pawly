            ...
            children: [
              ...
              ...List.generate(
                ...
                (index) => detailWidgetPrice(
                  title:
                      '${bookingDetail.value.payment.taxs[index].title} ${(bookingDetail.value.payment.taxs[index].title == "Sales Tax" || bookingDetail.value.payment.taxs[index].title == "Other Taxes") && bookingDetail.value.payment.taxs[index].taxType == "percentage" ? "( ${bookingDetail.value.payment.taxs[index].taxValue}%" : bookingDetail.value.payment.taxs[index].taxType == "fixed" ? "( \$${bookingDetail.value.payment.taxs[index].taxValue}" : bookingDetail.value.payment.taxs[index].taxValue} )',
                  value: bookingDetail.value.payment.taxs[index].value,
