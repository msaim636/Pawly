...
class BookingDataModel {
  ...
  factory BookingDataModel.fromJson(Map<String, dynamic> json) {
    ...
    return BookingDataModel(
      ...
      petDetails: json['pet_details'] is Map
          ...
          : PetData(),
      additionalInfo: json['addition_information'] is String ? json['addition_information'] : '',
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'addition_information': additionalInfo.trim(),
    };
  }
}
...
class PaymentDetails {
  ...
  factory PaymentDetails.fromJson(Map<String, dynamic> json) {
    return PaymentDetails(
      ...
      transactionType: json['transaction_type'] is String
