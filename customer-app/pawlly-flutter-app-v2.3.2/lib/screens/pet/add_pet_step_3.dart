      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            32.height,
            Text('${locale.value.weight} ${locale.value.lblIn} ${addPetInfoController.selectedWeightUnit.value.value})', style: primaryTextStyle()).paddingSymmetric(horizontal: 16),
            8.height,
            Obx(
              () => Row(
                crossAxisAlignment: CrossAxisAlignment.start,
            ...
            32.height,
            Text('${locale.value.height} ${locale.value.lblIn} ${addPetInfoController.selectedHeightUnit.value.value})', style: primaryTextStyle()).paddingSymmetric(horizontal: 16),
            8.height,
            Obx(
              () => Row(
                crossAxisAlignment: CrossAxisAlignment.start,
              ...
              child: Row(
                ...
                children: [
                  ...
                  AppButton(
                      ...
                      onTap: () async {
                        if (addPetInfoController.isLoading.value) return;

                        if (!await isNetworkAvailable() && addPetInfoController.isPetAdding.value) {
                          ...
                          if (addPetInfoController.imageFile.value.path.isEmpty && addPetInfoController.petProfileData.value.petImage.isEmpty) {
                            ...
                            if (_step3formKey.currentState!.validate()) {
                              ...
                              addPetInfoController.isLoading.value = true; // Lock
                              await addPetInfoController.addPetApi(); // Call API
                              // Unlocking happens inside addPetApi using .then() and .catchError()
                            }
                          }
                        }
                      }).expand(),
            ...
            children: [
              SizedBox(
                ...
                child: RadioGroup<String>(
                  ...
                  onChanged: (value) {
                    if (value != null) {
                      addPetInfoController.genderOption(value);
                    }
                  },
                  child: RadioListTile<String>(
                    ...
                    title: Text(
                      locale.value.female.capitalizeFirstLetter(),
              ...
              SizedBox(
                ...
                child: RadioGroup<String>(
                  ...
                  child: RadioListTile<String>(
                    ...
                    fillColor: WidgetStateProperty.all(primaryColor),
                    title: Text(
                      locale.value.male.capitalizeFirstLetter(),
                      style: secondaryTextStyle(),
                    ),
                  ),
                ),
  ...
  Widget birthdateWidget(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        AppTextField(
          ...
          onTap: () async {
            DateTime? selectedDate = await showDatePicker(
              context: context,
              initialDate: addPetInfoController.birthdayCont.text.isEmpty ? DateTime.now() : DateTime.parse(addPetInfoController.birthdayCont.value.text),
              firstDate: DateTime(1900),
              lastDate: DateTime.now(),
              builder: (context, child) {
                return Theme(
                  data: Theme.of(context).copyWith(dividerColor: Colors.transparent, dividerTheme: DividerThemeData(color: Colors.transparent), textTheme: TextTheme(displayMedium: primaryTextStyle())),
                  child: child!,
                );
              },
            );
            ...
            if (selectedDate != null) {
              ...
              addPetInfoController.setDate(selectedDate);
            } else {
        ...
        Obx(() {
          return AppTextField(
            title: locale.value.age,
            textStyle: primaryTextStyle(size: 12),
            controller: addPetInfoController.ageCont,
            textFieldType: TextFieldType.NAME,
            decoration: inputDecoration(
              context,
              hintText: locale.value.age,
              fillColor: context.cardColor,
              filled: true,
            ),
          ).paddingSymmetric(horizontal: 16);
